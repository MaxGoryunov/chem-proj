<div class="container">
    ...
    <form class="container__form" method="POST">
        <div class="form-group">
            ...
            <input class="form-control container__input" type="text" name="gender_name" value="<?= $gender['gender_name']; ?>"> <br>
        </div>
        <div class="form-group">
            <label  class="container__formlabel" for=""> Краткое название: </label>
            <input class="form-control container__input" type="text" name="gender_short_name" value="<?= $gender['gender_short_name']; ?>"> <br>
        </div>
