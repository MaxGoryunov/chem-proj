<div class="container">
    <h2 class="container__header">Редактирование статуса пользователя</h2>
    <form class="container__form" method="POST">
        <div class="form-group">
            <label  class="container__formlabel" for=""> Название: </label>
            <input class="form-control container__input" type="text" name="user_status_name" value="<?= $userStatus['user_status_name']; ?>"> <br>
        </div>
